...
public class SanPhamTester {
    ...
    public void testAddSuccessful() throws SQLException {
        ...
        String tenSanPham = "San Pham UnitTest";
        double gia = 999999;
        String donVi = "Test Xiu";
        int idKhuyenMai = 1;
        int idChiNhanh = 1;
    ...
    public void testSearchSanPham_byTenSanPham() throws SQLException {
        String keyword_tenSanPham = "true";
    ...
    public void testSearchSanPham_byIdChiNhanh() throws SQLException {
        ...
        System.err.println("size cua List = " + sanPhams.size());
        Assertions.assertEquals(12, sanPhams.size());
    ...
    public void testDelete() throws SQLException {
        ...
        boolean check;
        try {
            check = sanPhamService.deleteSanPham(Integer.toString(idSanPham));
            Assertions.assertTrue(check);
    ...
    public void testUpdateSuccessful() throws SQLException {
        ...
        SanPham sanPham = new SanPham(idSanPham, "Test Xiu Thoi", 777, donVi, idKhuyenMai, idChiNhanh);
        sanPhamService.addSanPham(sanPham);
