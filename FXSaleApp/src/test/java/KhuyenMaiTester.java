...
public class KhuyenMaiTester {
    ...
    public void testAddSuccessful() throws SQLException {
        ...
        String tenKhuyenMai = "FREE " + idKhuyenMai;
    ...
    public void testDelete() {
        String keyword_id = "12";
        boolean check;
        try {
            check = khuyenMaiService.deleteKhuyenMai(keyword_id);
            Assertions.assertTrue(check);
    ...
    public void updateSuccessful() {
        String id = "12";
        String tenKhuyenMaiNew = "TRẦN ĐĂNG TUẤN";
        ...
        boolean check;
        try {
            check = khuyenMaiService.updateKhuyenMai(id, tenKhuyenMaiNew, Double.parseDouble(giaTriNew), ngayBatDau, ngayKetThuc);
            Assertions.assertTrue(check);
