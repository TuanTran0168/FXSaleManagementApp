...
public class NhanVienTester {
    ...
    public void testSearchNhanVien_byId() throws SQLException {
        ...
        System.err.println("id cua Thanh Vien = " + nhanViens.get(0).getIdNhanVien());
    ...
    @Test
    public void testSearchNhanVien_byChiNhanh() throws SQLException {
    ...
    public void updateSuccessful() {
        ...
        boolean check;
        try {
            check = nhanVienService.updateNhanVien(matKhau, hoNhanVien, tenNhanVien, idChiNhanh, taiKhoan, matKhau, quanLy);
            Assertions.assertTrue(check);
